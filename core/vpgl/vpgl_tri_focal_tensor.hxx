...
vpgl_tri_focal_tensor<Type>::normalize()
{
  ...
  if (s < ptol)
  {
    std::cout << " Frobenius norm too low - " << s << " < "
              << ptol << " can't normalize" << std::endl;
    return;
  }
  for (size_t i = 0; i < 3; ++i)
    for (size_t j = 0; j < 3; ++j)
                                                         ...
                                                         std::vector<vgl_homg_line_2d<Type>> & lines) const
{
  ...
  /* 0 */
  {
    Type lx = x2 * y3 * T_(0, 1, 0)
            - y2 * y3 * T_(0, 0, 0)
            - x2 * x3 * T_(0, 1, 1)
            + y2 * x3 * T_(0, 0, 1);

    Type ly = x2 * y3 * T_(1, 1, 0)
            - y2 * y3 * T_(1, 0, 0)
            - x2 * x3 * T_(1, 1, 1)
            + y2 * x3 * T_(1, 0, 1);

    Type lz = x2 * y3 * T_(2, 1, 0)
            - y2 * y3 * T_(2, 0, 0)
            - x2 * x3 * T_(2, 1, 1)
            + y2 * x3 * T_(2, 0, 1);
  ...
  /* 1 */
  {
    Type lx = x2 * z3 * T_(0, 1, 0)
            - y2 * z3 * T_(0, 0, 0)
            - x2 * x3 * T_(0, 1, 2)
            + y2 * x3 * T_(0, 0, 2);

    Type ly = x2 * z3 * T_(1, 1, 0)
            - y2 * z3 * T_(1, 0, 0)
            - x2 * x3 * T_(1, 1, 2)
            + y2 * x3 * T_(1, 0, 2);

    Type lz = x2 * z3 * T_(2, 1, 0)
            - y2 * z3 * T_(2, 0, 0)
            - x2 * x3 * T_(2, 1, 2)
            + y2 * x3 * T_(2, 0, 2);
  ...
  /* 2 */
  {
    Type lx = x2 * z3 * T_(0, 1, 1)
            - y2 * z3 * T_(0, 0, 1)
            - x2 * y3 * T_(0, 1, 2)
            + y2 * y3 * T_(0, 0, 2);

    Type ly = x2 * z3 * T_(1, 1, 1)
            - y2 * z3 * T_(1, 0, 1)
            - x2 * y3 * T_(1, 1, 2)
            + y2 * y3 * T_(1, 0, 2);

    Type lz = x2 * z3 * T_(2, 1, 1)
            - y2 * z3 * T_(2, 0, 1)
            - x2 * y3 * T_(2, 1, 2)
            + y2 * y3 * T_(2, 0, 2);
  ...
  /* 3 */
  {
    Type lx = x2 * y3 * T_(0, 2, 0)
            - z2 * y3 * T_(0, 0, 0)
            - x2 * x3 * T_(0, 2, 1)
            + z2 * x3 * T_(0, 0, 1);

    Type ly = x2 * y3 * T_(1, 2, 0)
            - z2 * y3 * T_(1, 0, 0)
            - x2 * x3 * T_(1, 2, 1)
            + z2 * x3 * T_(1, 0, 1);

    Type lz = x2 * y3 * T_(2, 2, 0)
            - z2 * y3 * T_(2, 0, 0)
            - x2 * x3 * T_(2, 2, 1)
            + z2 * x3 * T_(2, 0, 1);
  ...
  /* 4 */
  {
    Type lx = x2 * z3 * T_(0, 2, 0)
            - z2 * z3 * T_(0, 0, 0)
            - x2 * x3 * T_(0, 2, 2)
            + z2 * x3 * T_(0, 0, 2);

    Type ly = x2 * z3 * T_(1, 2, 0)
            - z2 * z3 * T_(1, 0, 0)
            - x2 * x3 * T_(1, 2, 2)
            + z2 * x3 * T_(1, 0, 2);

    Type lz = x2 * z3 * T_(2, 2, 0)
            - z2 * z3 * T_(2, 0, 0)
            - x2 * x3 * T_(2, 2, 2)
            + z2 * x3 * T_(2, 0, 2);
  ...
  /* 5 */
  {
    Type lx = x2 * z3 * T_(0, 2, 1)
            - z2 * z3 * T_(0, 0, 1)
            - x2 * y3 * T_(0, 2, 2)
            + z2 * y3 * T_(0, 0, 2);

    Type ly = x2 * z3 * T_(1, 2, 1)
            - z2 * z3 * T_(1, 0, 1)
            - x2 * y3 * T_(1, 2, 2)
            + z2 * y3 * T_(1, 0, 2);

    Type lz = x2 * z3 * T_(2, 2, 1)
            - z2 * z3 * T_(2, 0, 1)
            - x2 * y3 * T_(2, 2, 2)
            + z2 * y3 * T_(2, 0, 2);
  ...
  /* 6 */
  {
    Type lx = y2 * y3 * T_(0, 2, 0)
            - z2 * y3 * T_(0, 1, 0)
            - y2 * x3 * T_(0, 2, 1)
            + z2 * x3 * T_(0, 1, 1);

    Type ly = y2 * y3 * T_(1, 2, 0)
            - z2 * y3 * T_(1, 1, 0)
            - y2 * x3 * T_(1, 2, 1)
            + z2 * x3 * T_(1, 1, 1);

    Type lz = y2 * y3 * T_(2, 2, 0)
            - z2 * y3 * T_(2, 1, 0)
            - y2 * x3 * T_(2, 2, 1)
            + z2 * x3 * T_(2, 1, 1);
  ...
  /* 7 */
  {
    Type lx = y2 * z3 * T_(0, 2, 0)
            - z2 * z3 * T_(0, 1, 0)
            - y2 * x3 * T_(0, 2, 2)
            + z2 * x3 * T_(0, 1, 2);

    Type ly = y2 * z3 * T_(1, 2, 0)
            - z2 * z3 * T_(1, 1, 0)
            - y2 * x3 * T_(1, 2, 2)
            + z2 * x3 * T_(1, 1, 2);

    Type lz = y2 * z3 * T_(2, 2, 0)
            - z2 * z3 * T_(2, 1, 0)
            - y2 * x3 * T_(2, 2, 2)
            + z2 * x3 * T_(2, 1, 2);
  ...
  /* 8 */
  {
    Type lx = y2 * z3 * T_(0, 2, 1)
            - z2 * z3 * T_(0, 1, 1)
            - y2 * y3 * T_(0, 2, 2)
            + z2 * y3 * T_(0, 1, 2);

    Type ly = y2 * z3 * T_(1, 2, 1)
            - z2 * z3 * T_(1, 1, 1)
            - y2 * y3 * T_(1, 2, 2)
            + z2 * y3 * T_(1, 1, 2);

    Type lz = y2 * z3 * T_(2, 2, 1)
            - z2 * z3 * T_(2, 1, 1)
            - y2 * y3 * T_(2, 2, 2)
            + z2 * y3 * T_(2, 1, 2);
