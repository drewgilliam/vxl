...
class vpgl_affine_tri_focal_tensor : public vpgl_tri_focal_tensor<Type>
{
 ...
 public:
  ...
  {
    *this = vpgl_affine_tri_focal_tensor(
      vpgl_affine_camera<Type>(m1), vpgl_affine_camera<Type>(m2), vpgl_affine_camera<Type>(m3));
  }
  ...
  {
    *this = vpgl_affine_tri_focal_tensor(
      vpgl_affine_camera<Type>(), vpgl_affine_camera<Type>(m2), vpgl_affine_camera<Type>(m3));
  }
